 ...
 */
public class SearchTreePrinter {
    public static void printSubtreeWithRoot(SearchNode n, int indentationLevel) {
    ...
    public static void printSubtreeWithRoot2(SearchNode n, String indentationString) {
    ...
    public static void printTree(BinarySearchTree T) {
